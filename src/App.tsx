...
const NIBBLE_LOOKUP = new Map<string, number>(
  NIBBLE_ALPHABET.map((char, index) => [char, index]),
)
  ...
  return (
    <main dir="rtl" className="min-h-screen">
      <div className="mx-auto flex w-full max-w-screen-md flex-col gap-8 px-4 py-10 md:py-14">
        <header
          className="space-y-4 text-right animate-fade-up"
        ...
        >
          ...
          <div className="space-y-2">
            ...
            <p className="text-sm text-muted-foreground md:text-base">
              متن خود را با کلید دلخواه یا کلید روزانه تبدیل کنید. خروجی از حروف
              فارسی ساخته می‌شود تا خوانایی حفظ شود.
            </p>
          </div>
        </header>
            ...
            <Tabs defaultValue="encode" className="w-full">
              ...
              <TabsContent value="info">
                <div className="space-y-5 text-sm text-muted-foreground leading-7">
                  <p>
                    این ابزار متن را با یک کلید چرخشی روزانه یا کلید دلخواه شما
                    به یک رشته فارسی تبدیل می‌کند. اگر برای بازگشایی مشکلی دارید،
                    مطمئن شوید از همان کلید استفاده شده است.
                  </p>
                  <div className="rounded-lg border border-border/60 bg-muted/30 p-4">
                    ...
                    <p className="mt-2 text-sm text-muted-foreground">
                      برای حمایت، شناسه یا لینک پرداخت خودتان را اینجا قرار دهید.
                      این بخش فقط یک جاگیر است و قابل شخصی‌سازی است.
                    </p>
